...
import { LaptopFilter } from './LaptopsFilter.js'
...
const FilterBar = ({checkBoxesBrand, setCheckBoxesBrand}) =>{
          ...
          <div className={classes.checkBoxes}>
                ...
                <Typography component="legend">Brands</Typography>
                    <FormGroup>
                        ...
                        {  LaptopFilter.map((item, index)=>{
                            return(
                                <div className={classes.checkBoxes}>
                      {item.filterType==="brand"?item.filterOptions.map((item, index)=>{
                            return(
                                <FormControlLabel
                    control={<GreenCheckbox defaultChecked={true} color="success"  
                    onChange={handleCheckBoxBrand} name={item.name}/>}
                    label={item.label}
                  />
                            )
                      }):null}     
